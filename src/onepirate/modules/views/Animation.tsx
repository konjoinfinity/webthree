...
const baebees: [string, string, string][] = [
  ["https://reautydao.io/wp-content/uploads/Kid.png", "Pure Baebee","Baebee wishes the world full of love, purity, and sincerity, calling the beauty stakeholders should build a trustworthy beauty community in web3, share authentic information, read reviews, and trustful marketing; let's become a kid live in a pure beauty world."],
  ["https://reautydao.io/wp-content/uploads/Leaf.png","Vegan Baebee","We are supporting vegan beauty,  the absence of animal ingredients, while cruelty-free refers to a product that doesn't test on animals; Vegan Baebee is on behalf of our Reauty Community to promote the Cruelty-Free concept!"],
